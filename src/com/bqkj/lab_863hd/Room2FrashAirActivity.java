...
public class Room2FrashAirActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.room2freshair);
		...
		iv_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Room2FrashAirActivity.this,
						MainActivity.class);
	...
	protected void onDestroy() {
		...
		if (receiver != null) {
			Room2FrashAirActivity.this.unregisterReceiver(receiver);
		}
	}
	...
	protected void onResume() {
		...
		Room2FrashAirActivity.this.registerReceiver(receiver, filter);
	}
