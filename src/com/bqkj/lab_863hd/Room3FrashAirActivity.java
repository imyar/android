...
public class Room3FrashAirActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.room3freshair);
		...
		iv_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Room3FrashAirActivity.this,
						MainActivity.class);
	...
	protected void onDestroy() {
		...
		if (receiver != null) {
			Room3FrashAirActivity.this.unregisterReceiver(receiver);
		}
	}
	...
	protected void onResume() {
		...
		Room3FrashAirActivity.this.registerReceiver(receiver, filter);
	}
