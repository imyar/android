...
public class Room6FrashAirActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.room6freshair);
		...
		iv_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Room6FrashAirActivity.this,
						MainActivity.class);
	...
	protected void onDestroy() {
		...
		if (receiver != null) {
			Room6FrashAirActivity.this.unregisterReceiver(receiver);
		}
	}
	...
	protected void onResume() {
		...
		Room6FrashAirActivity.this.registerReceiver(receiver, filter);
	}
