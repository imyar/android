...
public class Room4FrashAirActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.room4freshair);
		...
		iv_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Room4FrashAirActivity.this,
						MainActivity.class);
	...
	protected void onDestroy() {
		...
		if (receiver != null) {
			Room4FrashAirActivity.this.unregisterReceiver(receiver);
		}
	}
	...
	protected void onResume() {
		...
		Room4FrashAirActivity.this.registerReceiver(receiver, filter);
	}
