...
public class Room1FrashAirActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.room1freshair);
		...
		iv_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Room1FrashAirActivity.this,
						MainActivity.class);
	...
	protected void onDestroy() {
		...
		if (receiver != null) {
			Room1FrashAirActivity.this.unregisterReceiver(receiver);
		}
	}
	...
	protected void onResume() {
		...
		Room1FrashAirActivity.this.registerReceiver(receiver, filter);
	}
